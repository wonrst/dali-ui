...
int UtcDaliTextRevealLineSequenceScheduleP(void)
{
  ...
  DALI_TEST_CHECK(Reveal::ApplyLineSequenceSchedule(equalLines, equalLineRuns.data(), equalLineRuns.size(), 0.0f));
  ...
  DALI_TEST_CHECK(Reveal::ApplyLineSequenceSchedule(uneven, unevenLines.data(), unevenLines.size(), 0.0f));
  ...
  DALI_TEST_CHECK(Reveal::ApplyLineSequenceSchedule(withShortLine,
  ...
  DALI_TEST_CHECK(Reveal::ApplyLineSequenceSchedule(ratioOne, unevenLines.data(), unevenLines.size(), 1.0f));
  ...
  for(float authoredFade : {UiText::Reveal::AUTO_FADE_DURATION_RATIO, 0.25f, 0.0f})
  {
    for(float ratio : {0.0f, 0.5f, 1.0f})
    {
      ...
      DALI_TEST_CHECK(Reveal::ApplyLineSequenceSchedule(singleton,
                                                        singletonLines.data(),
                                                        singletonLines.size(),
                                                        ratio));
  ...
  DALI_TEST_CHECK(Reveal::ApplyLineSequenceSchedule(singleLine, singleLineRuns.data(), singleLineRuns.size(), 1.0f));
  ...
  DALI_TEST_CHECK(Reveal::ApplyLineSequenceSchedule(crossLineWord,
                                                    crossLineRuns.data(),
                                                    crossLineRuns.size(),
                                                    0.5f));
  ...
  DALI_TEST_CHECK(Reveal::ApplyLineSequenceSchedule(blankLine, blankRuns.data(), blankRuns.size(), 0.5f));
  ...
  DALI_TEST_CHECK(Reveal::ApplyLineSequenceSchedule(bidi, bidiLines.data(), bidiLines.size(), 0.5f));
  ...
  DALI_TEST_CHECK(Reveal::ApplyLineSequenceSchedule(splitLine, splitRuns.data(), splitRuns.size(), 0.5f));
  ...
  DALI_TEST_CHECK(!Reveal::ApplyLineSequenceSchedule(incompleteMapping,
                                                     incompleteRuns.data(),
                                                     incompleteRuns.size(),
                                                     0.5f));
  ...
  DALI_TEST_CHECK(Reveal::ApplyLineSequenceSchedule(stressPlan,
                                                    stressLines.data(),
                                                    stressLines.size(),
                                                    0.25f));
...
int UtcDaliTextRevealLineSequenceFinalLayoutP(void)
{
...
int UtcDaliTextRevealLineSequenceMaximumLinesEndEllipsisP(void)
{
  UiTestApplication application;
